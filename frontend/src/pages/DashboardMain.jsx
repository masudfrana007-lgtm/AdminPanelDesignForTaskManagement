...
export default function DashboardMain() {
  ...
  return (
    <div className="db">
      ...
      <div className="dbTop">
        <button className="dbBurger" type="button" aria-label="Menu">
          <span />
          <span />
          <span />
        </button>
        ...
        <div className="dbTopRight">
          <div className="dbUser">
            ...
            <div className="dbDot" title="Online" />
          </div>
          <button className="dbLogout" type="button">
            Logout
          </button>
        </div>
      </div>
        ...
        <section className="dbMid">
          <article className="panel panelChart">
            ...
            <div className="chartWrap">
              ...
              <svg className="chart" viewBox="0 0 640 280" role="img" aria-label="Revenue and withdraw line chart">
                {/* grid */}
                <g className="grid">
