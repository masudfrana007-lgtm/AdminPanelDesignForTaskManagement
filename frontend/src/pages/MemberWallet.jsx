...
import "./DepositRecord.css"; // ✅ reuse your DepositRecord UI
      ...
      <div className="container">
        <div className="topbar" style={{ alignItems: "flex-start" }}>
          ...
          <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
            <button className="btn" type="button" onClick={() => nav(-1)} disabled={busy}>
              ← Back
            </button>
            ...
            {canReview && (
              <>
                <Link className="btn" to={`/members/${memberId}/wallet/deposit/new`}>
                  + Create Deposit
                </Link>
                <Link className="btn" to={`/members/${memberId}/wallet/withdraw/new`}>
                  + Create Withdrawal
                </Link>
              </>
            )}
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(4, minmax(0, 1fr))", gap: 12 }}>
          ...
          <div className="card" style={{ margin: 0 }}>
            <div className="small">Total Deposit</div>
            <div style={{ fontSize: 22, fontWeight: 800 }}>{fmtMoney(totals.totalDeposit)}</div>
          </div>

          <div className="card" style={{ margin: 0 }}>
            <div className="small">Total Withdraw</div>
            <div style={{ fontSize: 22, fontWeight: 800 }}>{fmtMoney(totals.totalWithdraw)}</div>
          </div>
        </div>

        {/* Tabs + DepositRecord-like UI */}
        <div className="card" style={{ marginTop: 12 }}>
          ...
          <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
            <button
              ...
              style={{ opacity: tab === "deposits" ? 1 : 0.7 }}
            >
            ...
            <button
              ...
              style={{ opacity: tab === "withdrawals" ? 1 : 0.7 }}
            >
